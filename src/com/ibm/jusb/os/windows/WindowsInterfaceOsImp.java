 ...
 */
class WindowsInterfaceOsImp extends DefaultUsbInterfaceOsImp implements UsbInterfaceOsImp
{
	/** Constructor */
	...
	public WindowsDeviceOsImp getWindowsDeviceOsImp() { return windowsDeviceOsImp; }

	/** @param device The WindowsDeviceOsImp for this */
	public void setWindowsDeviceOsImp( WindowsDeviceOsImp device ) { windowsDeviceOsImp = device; }
