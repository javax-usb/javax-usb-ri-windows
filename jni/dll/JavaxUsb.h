...
#include "com_ibm_jusb_os_windows_JavaxUsb.h"
...
#define SPEED_UNKNOWN com_ibm_jusb_os_windows_JavaxUsb_SPEED_UNKNOWN
#define SPEED_LOW com_ibm_jusb_os_windows_JavaxUsb_SPEED_LOW
#define SPEED_FULL com_ibm_jusb_os_windows_JavaxUsb_SPEED_FULL
